...
#### [MFEU_CARD_TYPE](MFEU_CARD_TYPE) | 读卡类型返回
| 名称 | 值 | 说明 |
| :-------- | :--------| :------ |
...
#### [MFEU_MSR_REAUTH_RESP](MFEU_MSR_REAUTH_RESP) | 二次授权结果返回
| 名称 | 值 | 说明 |
| :-------- | :--------| :------ |
...
#### [MFEU_MSR_DEVSTAT](MFEU_MSR_DEVSTAT) | 设备密钥下载状态
| 名称 | 值 | 说明 |
| :-------- | :--------| :------ |
...
#### [MFEU_MSR_KEYTYPE](MFEU_MSR_KEYTYPE) | 密码输入按键返回
| 名称 | 值 | 说明 |
| :-------- | :--------| :------ |
...
#### [MFEU_MSR_INFO](MFEU_MSR_INFO) | MPOS交易提示
| 名称 | 值 | 说明 |
| :-------- | :--------| :------ |
...
#### [MFEU_KEY_LENGTH](MFEU_KEY_LENGTH) 密钥长度
| 名称 | 值 | 说明 |
| :-------- | :--------| :------ |
...
#### [MFEU_ENCRYPT_METHOD](MFEU_ENCRYPT_METHOD) 加密方式
| 名称 | 值 | 说明 |
| :-------- | :--------| :------ |
...
#### [MFEU_KEY_INDEX](MFEU_KEY_INDEX) 密钥索引号
| 名称 | 值 | 说明 |
| :-------- | :--------| :------ |
...
#### [MFEU_WKEY_TYPE](MFEU_WKEY_TYPE) | 工作密钥类型
| 名称 | 值 | 说明 |
| :-------- | :--------| :------ |
...
#### [MFEU_MAC_ALG](MFEU_MAC_ALG) | MAC算法
| 名称 | 值 | 说明 |
| :-------- | :--------| :------ |
...
#### [MFEU_PIN_ENCRYPT](MFEU_PIN_ENCRYPT) | PIN加密2 - 算法类型
| 名称 | 值 | 说明 |
| :-------- | :--------| :------ |
...
#### [MFEU_ECASH_TRADE](MFEU_ECASH_TRADE) | 电子现金交易指示器
| 名称 | 值 | 说明 |
| :-------- | :--------| :------ |
| MF_ECASH_FORBIT | 0x00 | 不支持 |
| MF_ECASH_PERMIT | 0x01 | 支持 |

#### [MFEU_PBOC_FLOW](MFEU_PBOC_FLOW) | PBOC流程指示
| 名称 | 值 | 说明 |
| :-------- | :--------| :------ |
| MF_PBOC_FULL | 0x06 | 读应用数据 |
| MF_PBOC_PART | 0x01 | 第一次密文生成 |

#### [MFEU_IC_ONLINE](MFEU_IC_ONLINE) | IC卡操作是否联机
| 名称 | 值 | 说明 |
| :-------- | :--------| :------ |
| MF_ONLINE_NO | 0x30 | 不强制联机 |
| MF_ONLINE_YES | 0x31 | 强制联机 |

#### [MFEU_ONLINE_RESULT](MFEU_ONLINE_RESULT) | 是否联机成功
| 名称 | 值 | 说明 |
| :-------- | :--------| :------ |
| MF_ONLINE_SUCC | 0x00 | 联机成功 |
| MF_ONLINE_FAIL | 0x01 | 联机未成功 |

#### [MFEU_PINREQ](MFEU_PINREQ) | PIN输入指示
| 名称 | 值 | 说明 |
| :-------- | :--------| :------ |
...
#### [MFEU_FAILBACK](MFEU_FAILBACK) | 是否允许降级
| 名称 | 值 | 说明 |
| :-------- | :--------| :------ |
| MF_FAILBACK_NO | 0x00 | 不允许降级 |
| MF_FAILBACK_YES | 0x01 | 允许降级 |

#### [MFEU_TRADE_TYPE](MFEU_TRADE_TYPE) | 交易类型
| 名称 | 值 | 说明 |
| :-------- | :--------| :------ |
...
#### [MFEU_DUKPT_ALG](MFEU_DUKPT_ALG) | DUKPT密钥类型
| 名称 | 值 | 说明 |
| :-------- | :--------| :------ |
...
#### [MFEU_DUKPT_TYPE](MFEU_DUKPT_TYPE) | DUKPT加密方式
| 名称 | 值 | 说明 |
| :-------- | :--------| :------ |
...
#### [MFEU_DUKPT_METHOD](MFEU_DUKPT_METHOD) DUKPT DES计算加密方式
| 名称 | 值 | 说明 |
| :-------- | :--------| :------ |
...
#### [MFEU_MSR_UPGRADE_STAT](MFEU_MSR_UPGRADE_STAT) | 升级状态返回
| 名称 | 值 | 说明 |
| :-------- | :--------| :------ |
